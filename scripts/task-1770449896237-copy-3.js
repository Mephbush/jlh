 ...
 * ID: task-1770449896237
 * Generated: 2026-02-08T00:05:47.251Z
 */
...
const TASK_NAME = process.env.TASK_NAME || 'task-1770449896237';
const TARGET_URL = process.env.TARGET_URL || 'undefined';
const STEALTH_LEVEL = process.env.STEALTH_LEVEL || 'basic';
